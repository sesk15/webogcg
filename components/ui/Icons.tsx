...
export const IconCalendar = ({ size = 16, color = "currentColor" }: { size?: number; color?: string }) => (
...
export const IconPin = ({ size = 16, color }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color || "currentColor"} strokeWidth="2" aria-hidden="true">
    <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/>
  </svg>
);

export const IconMusic = ({ size = 40, color }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color || "currentColor"} strokeWidth="1.5" aria-hidden="true">
    <path d="M9 18V5l12-2v13"/><circle cx="6" cy="18" r="3"/><circle cx="18" cy="16" r="3"/>
  </svg>
);

export const IconArrowRight = ({ size = 14, color }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color || "currentColor"} strokeWidth="3" aria-hidden="true">
    <polyline points="9 18 15 12 9 6"/>
  </svg>
);

export const IconArrowDown = ({ size = 20, color }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color || "currentColor"} strokeWidth="2" aria-hidden="true">
...
export const IconMic = ({ size = 28, color }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color || "currentColor"} strokeWidth="1.75" aria-hidden="true">
...
export const IconWind = ({ size = 28, color }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color || "currentColor"} strokeWidth="1.75" aria-hidden="true">
    <path d="M9.59 4.59A2 2 0 1 1 11 8H2m10.59 11.41A2 2 0 1 0 14 16H2m15.73-8.27A2.5 2.5 0 1 1 19.5 12H2"/>
  </svg>
);

export const IconDrum = ({ size = 28, color }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color || "currentColor"} strokeWidth="1.75" aria-hidden="true">
...
export const IconCommunity = ({ size = 28, color }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color || "currentColor"} strokeWidth="1.75" aria-hidden="true">
...
export const IconStar = ({ size = 28, color }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color || "currentColor"} strokeWidth="1.75" aria-hidden="true">
...
export const IconGlobe = ({ size = 28, color }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color || "currentColor"} strokeWidth="1.75" aria-hidden="true">
...
export const IconUser = ({ size = 16, color = "currentColor" }: { size?: number; color?: string }) => (
...
export const IconMail = ({ size = 16, color = "currentColor" }: { size?: number; color?: string }) => (
...
export const IconPhone = ({ size = 16, color = "currentColor" }: { size?: number; color?: string }) => (
...
export const IconClock = ({ size = 16, color = "currentColor" }: { size?: number; color?: string }) => (
...
export const IconMapPin = ({ size = 16, color = "currentColor" }: { size?: number; color?: string }) => (
...
export const IconShieldCheck = ({ size = 16, color = "currentColor" }: { size?: number; color?: string }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><polyline points="9 12 11 14 15 10"/></svg>
);

export const IconCheck = ({ size = 16, color = "currentColor" }: { size?: number; color?: string }) => (
...
export const IconExternalLink = ({ size = 16, color = "currentColor" }: { size?: number; color?: string }) => (
