...
export const IconMail = ({ size = 16, color = "currentColor" }: IconProps) => (
...
export const IconPhone = ({ size = 16, color = "currentColor" }: IconProps) => (
...
export const IconMapPin = ({ size = 16, color = "currentColor" }: IconProps) => (
...
export const IconShieldCheck = ({ size = 16, color = "currentColor" }: IconProps) => (
...
export const IconExternalLink = ({ size = 16, color = "currentColor" }: IconProps) => (
